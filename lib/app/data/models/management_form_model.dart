...
class Parameter {
  Parameter({
    ...
    required this.parameterNameLang,
  ...
  final String? parameterNameLang; // Added this field
  ...
  final String? statusRequired; // Added this field based on JSON
  ...
  factory Parameter.fromJson(Map<String, dynamic> json) {
    return Parameter(
      ...
      parameterNameLang: json["parameter_name_lang"],
      ...
      statusRequired: json["status_required"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "parameter_name_lang": parameterNameLang,
